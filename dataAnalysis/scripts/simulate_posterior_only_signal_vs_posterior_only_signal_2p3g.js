...
import { PosteriorOnlySignalAgent } from '../../client/src/ai/PosteriorOnlySignalAgent.js';
...
const DEFAULT_OUTPUT_DIR = 'dataAnalysis/model_model/signal_agent/outputs/signal_agent_posterior_only_lambda_p_fit/simulations';
const DEFAULT_RAW_OUTPUT_DIR = 'dataAnalysis/raw_data/model_model_simulations/signal_agent/posterior_only_lambda_p_fit';
...
function summarizeTrial(trialData, mapId, sessionIndex) {
  ...
  return {
    ...
    player1SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer1SampledJointGoal,
    player2SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer2SampledJointGoal,
...
function buildRawTrialRecord(trialData, mapId, sessionIndex, design) {
  ...
  return {
    ...
    partnerType: 'posteriorOnlySignalAgent',
    experimentType: '2P3G',
    trialIndex: trialData.trialIndex,
    mapId,
    distanceCondition: trialData.distanceCondition,
    ...
    player1SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer1SampledJointGoal,
    player2SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer2SampledJointGoal,
    posteriorOnlySignalAgentPlayer1SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer1SampledJointGoal,
    posteriorOnlySignalAgentPlayer2SampledJointGoal: trialData.posteriorOnlySignalAgentPlayer2SampledJointGoal,
    posteriorOnlySignalAgentPlayer1SampledJointGoalWeights: trialData.posteriorOnlySignalAgentPlayer1SampledJointGoalWeights,
    posteriorOnlySignalAgentPlayer2SampledJointGoalWeights: trialData.posteriorOnlySignalAgentPlayer2SampledJointGoalWeights,
    posteriorOnlySignalAgentPlayer1SampledJointGoalHistory: trialData.posteriorOnlySignalAgentPlayer1SampledJointGoalHistory,
    posteriorOnlySignalAgentPlayer2SampledJointGoalHistory: trialData.posteriorOnlySignalAgentPlayer2SampledJointGoalHistory,
    posteriorOnlySignalAgentPlayer1MixtureP: trialData.posteriorOnlySignalAgentPlayer1MixtureP,
    posteriorOnlySignalAgentPlayer2MixtureP: trialData.posteriorOnlySignalAgentPlayer2MixtureP,
    posteriorOnlySignalAgentPlayer1MixturePicked: trialData.posteriorOnlySignalAgentPlayer1MixturePicked,
    posteriorOnlySignalAgentPlayer2MixturePicked: trialData.posteriorOnlySignalAgentPlayer2MixturePicked,
    posteriorOnlySignalAgentPosteriorOnlyGoalSelection: trialData.posteriorOnlySignalAgentPosteriorOnlyGoalSelection,
...
function runSimulation({ sessions, trialsPerSession, seed, sessionOffset, alpha, lambda, beta, score, horizon }) {
  ...
  CONFIG.game.players.player1.type = 'posteriorOnlySignalAgent';
  CONFIG.game.players.player2.type = 'posteriorOnlySignalAgent';
    ...
    return withSuppressedConsole(() => withSynchronousTimers(() => {
      ...
      for (let localSessionIndex = 0; localSessionIndex < sessions; localSessionIndex++) {
        ...
        withSeededRandom(sessionSeed, () => {
          ...
          const agent1 = new PosteriorOnlySignalAgent({ rlAgent: sharedRl, alpha, lambda, beta, score, horizon });
          const agent2 = new PosteriorOnlySignalAgent({ rlAgent: sharedRl, alpha, lambda, beta, score, horizon });
      ...
      return {
        summary: computeSummary(trials, {
          ...
          score,
          horizon,
          agentType: 'posteriorOnlySignalAgent',
...
function main() {
  ...
  const summaryPath = path.join(outputDir, `posterior_only_signal_vs_posterior_only_signal_2p3g_summary_${suffix}.json`);
  const trialsPath = path.join(outputDir, `posterior_only_signal_vs_posterior_only_signal_2p3g_trials_${suffix}.json`);
  const rawTrialsPath = path.join(rawOutputDir, `posterior_only_signal_vs_posterior_only_signal_2p3g_raw_trials_${suffix}.json`);
