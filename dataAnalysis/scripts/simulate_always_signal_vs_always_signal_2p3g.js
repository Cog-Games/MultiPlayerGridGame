...
import { AlwaysSignalAgent } from '../../client/src/ai/AlwaysSignalAgent.js';
...
function summarizeTrial(trialData, mapId, sessionIndex) {
  ...
  return {
    ...
    player1SampledJointGoal: trialData.alwaysSignalAgentPlayer1SampledJointGoal,
    player2SampledJointGoal: trialData.alwaysSignalAgentPlayer2SampledJointGoal,
...
function buildRawTrialRecord(trialData, mapId, sessionIndex, design, options = {}) {
  ...
  return {
    ...
    player1SampledJointGoal: trialData.alwaysSignalAgentPlayer1SampledJointGoal,
    player2SampledJointGoal: trialData.alwaysSignalAgentPlayer2SampledJointGoal,
    alwaysSignalAgentPlayer1SampledJointGoal: trialData.alwaysSignalAgentPlayer1SampledJointGoal,
    ...
    alwaysSignalAgentPlayer2MixturePicked: trialData.alwaysSignalAgentPlayer2MixturePicked,
    alwaysSignalAgentEveryStepResampling: trialData.alwaysSignalAgentEveryStepResampling,
...
function runSimulation({ sessions, trialsPerSession, seed, sessionOffset, alpha, lambda, beta, score, horizon, unshapedJointRL, compactDiagnostics }) {
  ...
  CONFIG.game.players.player1.type = 'alwaysSignalAgent';
  CONFIG.game.players.player2.type = 'alwaysSignalAgent';
