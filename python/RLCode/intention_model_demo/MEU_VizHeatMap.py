...
class RunVI:
    ...
    def __call__(self, goalStates, obstacles):
        ...
        terminalValue = dict(zip(goalStates,self.goalReward))
        print(terminalValue)
...
###
        ...
        # viz policy
            getPolicy = SoftmaxRLPolicy(Q_dict, softmaxBeta=softmaxBeta)
...
# control
    ...
    obstacles = [(1,2),(1,6),(1,7),(2,2),(2,3),(2,4),(2,7),
