...
class RunVI:
    ...
    def __call__(self, goalStates, obstacles):
        ...
        env = GridWorld("test", nx=gridSize[0], ny=gridSize[1])
...
###
        ...
        if visualMap:
            ...
            df = pd.DataFrame(y, columns=[x for x in range(gridSize[1])])
        ...
        # viz policy
            ...
            # draw_Q_4d(ax, Q_dict, V=V, S=S, A=A)
